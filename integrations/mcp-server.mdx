...
| Voice calls | Meta: `call_initiate`, `calls_list`, `call_get`, `call_accept`, `call_reject`, `call_terminate`, `call_settings_get`/`update`, `call_permission_get`/`request`; EVO\_GO: `call_play`, `call_realtime_session` |
