...
description: "Connect AI agents to WhatsApp via the hosted Pilot Status MCP server: OAuth or x-api-key auth, 56 tools over the public /v1 API, per-number grants."
mode: "wide"
---
