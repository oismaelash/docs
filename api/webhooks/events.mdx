...
## Migration-layer events

If you connected through the Evolution GO or Evolution v2 compatibility layer, events are **also** forwarded to your webhook in that provider's **own native event format** (not the normalized schema above). See the event lists on the [Evolution GO](/api/layer/evolution-go) and [Evolution V2](/api/layer/evolution-v2) layer pages.
