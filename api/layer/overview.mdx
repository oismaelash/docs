...
description: "The Pilot Status API Layer accepts Evolution API-compatible requests, letting you switch providers by changing only your base URL — no code rewriting needed."
---
