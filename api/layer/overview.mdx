...
<CardGroup cols={2}>
  ...
  <Card title="Meta Cloud API" icon="meta" href="/api/layer/meta">
    Base URL: `https://pilotstatus.com.br/api/layer/meta/`

    Call the WhatsApp Cloud API (Graph API) directly — Pilot swaps your `ps_` key for the number's Meta system token.
  </Card>
</CardGroup>
...
- **Webhook events** — events are forwarded to your webhook in your provider's native event format; each provider layer page lists the exact events it emits
