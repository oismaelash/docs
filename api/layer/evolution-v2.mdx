...
description: "Use the Pilot Status Evolution V2 API Layer to migrate from Evolution API V2. Point your base URL to the Pilot Status layer and send messages without any code changes."
---
