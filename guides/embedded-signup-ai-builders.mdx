...
description: "Add a working WhatsApp signup button to an app built on Lovable, Replit, Bolt, v0 or Cursor by embedding Pilot Status's hosted button — no Facebook SDK, no Meta app of your own — with four copy-paste prompts for backend, iframe, connect:paired and webhooks."
mode: "wide"
---
