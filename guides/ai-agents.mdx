...
Pilot Status ships an official Model Context Protocol server that exposes the public `/v1` API as **56 MCP tools** — send messages, read conversations and unread messages, manage numbers, templates, webhooks, groups, voice calls, and more.
