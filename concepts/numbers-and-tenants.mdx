...
<Frame caption="The active-number selector in the header — every per-number page (Chat, Templates, Logs, API Keys…) follows the number selected here.">
  ![Active-number selector in the dashboard header](/images/dashboard/number-selector.png)
</Frame>
