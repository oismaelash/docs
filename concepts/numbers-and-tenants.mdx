---
title: "WhatsApp Numbers and Multi-Tenant Projects"
...
<Tabs>
  ...
  <Tab title="API">
    Send a `GET` request to `/api/numbers` to retrieve a list of all connected numbers in your project, including their IDs, status, and connection type.
...
<Info>
  Each plan includes a fixed number of connected numbers. If you need more than 13, contact Pilot Status for a custom plan.
</Info>
