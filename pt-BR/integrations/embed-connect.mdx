...
A aparência do botão é definida **na hora de gerar o link**, dentro de `branding.button`, e viaja no token assinado. Mandar esse objeto também põe o link em [modo botão](#modo-botao) por padrão, então esse único objeto é o pedido inteiro: *estilize um botão e receba um botão.*
