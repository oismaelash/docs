...
O Chatwoot **v4.15\+** traz suporte a chamadas de voz. Independentemente do Chatwoot, o painel **/chat** do Pilot Status inclui um softphone integrado para **números da Meta Cloud API**, permitindo que você atenda e faça chamadas do WhatsApp Business diretamente do painel.
