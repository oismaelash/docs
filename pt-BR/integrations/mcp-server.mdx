...
| Chamadas de voz | Meta: `call_initiate`, `calls_list`, `call_get`, `call_accept`, `call_reject`, `call_terminate`, `call_settings_get`, `call_settings_update`, `call_enable`, `call_permission_get`, `call_permission_request`; Web (não oficial): `call_play`, `call_realtime_session` |
