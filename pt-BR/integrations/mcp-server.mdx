...
description: "Conecte agentes de IA ao WhatsApp através do servidor MCP hospedado da Pilot Status: autenticação OAuth ou x-api-key, 65 ferramentas sobre a API pública /v1, concessões por número."
mode: "wide"
---
