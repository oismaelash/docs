...
<CardGroup cols={2}>
  ...
  <Card title="Meta Cloud API" icon="meta" href="/pt-BR/api/layer/meta">
    Base URL: `https://pilotstatus.com.br/api/layer/meta/`

    Chame a WhatsApp Cloud API (Graph API) direto — o Pilot troca sua chave `ps_` pela token de sistema da Meta do número.
  </Card>
</CardGroup>
