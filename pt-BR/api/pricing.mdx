...
<Note>
  **Planejado:** a tarifa armazenada já carrega um `fetchedAt` (quando puxamos a tabela pela última vez) e um `source`. Expor os dois nesta resposta é uma mudança pequena e está na lista — dá a idade do número sem ninguém ter de adivinhar a vigência.
</Note>
