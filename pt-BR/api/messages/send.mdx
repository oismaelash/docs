...
| Status | Significado |
| --- | --- |
| `400` | Payload inválido (ex.: telefone fora do E.164, campos obrigatórios ausentes, `MISSING_TEMPLATE_VARIABLES` / `INVALID_TEMPLATE_VARIABLE_VALUE` nomeando a chave, ou texto livre não suportado pelo provedor: `code: FREE_FORM_NOT_SUPPORTED`) |
