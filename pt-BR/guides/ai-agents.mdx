...
A Pilot Status disponibiliza um servidor oficial de Model Context Protocol que expõe a API pública `/v1` como **54 ferramentas MCP** — enviar mensagens, ler conversas e mensagens não lidas, gerenciar números, templates, webhooks, grupos, chamadas de voz e muito mais.
