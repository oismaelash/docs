...
O Pilot Status **não cobra** nada pelas chamadas. Em números Meta, os minutos de BIC são cobrados pela **Meta diretamente na sua WABA** — medidos em **pulsos de 6 segundos** (fração arredonda para cima) e tarifados por país de destino e tier de volume mensal; veja os [preços oficiais da Meta](https://developers.facebook.com/documentation/business-messaging/whatsapp/calling/pricing) e os [detalhes de cobrança](/pt-BR/api/calls/overview#preços-da-meta-para-chamadas-iniciadas-pela-empresa-números-oficiais). Em números Pilot Status web não há cobrança Meta por minuto.
...
<Frame caption="O softphone integrado no /chat — faça, atenda e encerre chamadas do WhatsApp; eventos de chamada (recebida, perdida, recusada) aparecem na conversa.">
  ![Softphone do painel no /chat mostrando uma chamada ativa do WhatsApp](/images/dashboard/softphone-call.png)
</Frame>
