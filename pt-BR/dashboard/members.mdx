...
**Revogar** é a mesma ação de remover membro: um botão só, porque convite e membership são a mesma linha por baixo. Linha pendente mostra _Revogar_; ativa mostra _Remover_.
