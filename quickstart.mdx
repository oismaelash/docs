...
<Steps>
  ...
  <Step title="Connect your number">
    ...
    <Frame caption="Connecting a number — scan the QR code or use the letter pairing code in WhatsApp (Linked devices).">
      ![Connecting a number in the Pilot Status dashboard](/images/dashboard/connect-qr.png)
    </Frame>
