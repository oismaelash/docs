...
<Frame caption="The Numbers page — connected numbers with provider badges (Unofficial / Embedded Signup) and the Connect Number button.">
  ![Pilot Status Numbers page](/images/dashboard/numbers.png)
</Frame>

<Frame caption="Connecting a number — choose between Meta Cloud API, Meta Coexistence, the unofficial Pilot Status API (QR code), or migration from another provider.">
...
<Tabs>
  <Tab title="Unofficial (QR Code)">
    ...
    <Steps>
      <Step title="Open the Numbers section">
        In your Pilot Status dashboard, navigate to **Dashboard → Numbers** and click **Connect Number**.
      </Step>
      <Step title="Select the Unofficial API card">
        On the connection type screen, choose the **Unofficial API** card (Pilot Status / QR Code).
      </Step>
      <Step title="Scan the QR code">
        ...
        <Frame caption="The Connect number modal — scan the QR code or type the letter pairing code in WhatsApp (Linked devices); codes expire and regenerate automatically.">
          ![Connect number modal with QR code and letter pairing code](/images/dashboard/connect-qr.png)
        </Frame>
      </Step>
  ...
  <Tab title="Official (Meta)">
    ...
    <Steps>
      ...
      <Step title="Select the Official Meta API card">
        On the connection type screen, choose the **Official Meta API** card (Cloud API or Coexistence, shown as separate cards).
      </Step>
